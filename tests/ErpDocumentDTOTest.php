...
class ErpDocumentDTOTest extends TestCase
{
    public function test_add_custom_initializes_customs_collection_when_null()
    {
        $dto = new ErpDocumentDTO();
    ...
    public function test_add_custom_supports_method_chaining()
    {
        $dto = new ErpDocumentDTO();
    ...
    public function test_add_custom_creates_custom_data_dto()
    {
        $dto = new ErpDocumentDTO();
    ...
    public function test_add_custom_handles_null_values()
    {
        $dto = new ErpDocumentDTO();
    ...
    public function test_get_custom_returns_null_when_customs_is_null()
    {
        $dto = new ErpDocumentDTO();
    ...
    public function test_get_custom_returns_null_when_customs_is_empty()
    {
        $dto = new ErpDocumentDTO();
    ...
    public function test_get_custom_method_exists_and_has_correct_signature()
    {
        $dto = new ErpDocumentDTO();
